...
export declare function generateAmountBitmap(
  amount: bigint,
  useShares: boolean,
  native: boolean,
): bigint
...
export declare function encodeCompoundV2SelectorId(
  amount: bigint,
  selectorId: number,
): bigint
export declare function encodeSiloV2CollateralMode(
  amount: bigint,
  mode: number,
): bigint
export declare function encodeAaveV4PmsBatchPermit(
  spoke: Address,
  pms: Address[],
  approvals: boolean[],
  nonce: bigint,
