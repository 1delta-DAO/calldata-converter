...
export function convertToTS(solidityCode: string, debug: boolean = false): ConverterOutput {
  ...
  import { encodePacked, uint128, uint8, uint112, uint16, uint256, _PRE_PARAM, _SHARES_MASK, _UNSAFE_AMOUNT, generateAmountBitmap, newbytes, bytes, getMorphoCollateral, getMorphoLoanAsset, rightPadZero } from "../../src/utils.ts";
  `
