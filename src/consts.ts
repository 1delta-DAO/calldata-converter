...
export const BASE_REPO_URL = "https://github.com/1delta-DAO/contracts-delegation/raw/refs/heads/main/"
...
export const HARDCODED_FUNCTIONS = ["generateAmountBitmap", "getMorphoCollateral", "getMorphoLoanAsset", "rightPadZero"]
