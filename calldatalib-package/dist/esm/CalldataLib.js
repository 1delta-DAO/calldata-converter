...
(function (LenderOps) {
    ...
    LenderOps[LenderOps["LISTA_BROKER_BORROW"] = 7] = "LISTA_BROKER_BORROW";
    LenderOps[LenderOps["LISTA_BROKER_REPAY"] = 8] = "LISTA_BROKER_REPAY";
...
export const UPPER_128BITS = 120n;
export const FLUID_ALL = -(1n << 127n);
export const FLUID_USE_BALANCE = (1n << 128n) - 1n;
export const FLUID_MAX_AMOUNT = (1n << 112n) - 1n;
export const FLUID_SMART_USE_BALANCE = (1n << 256n) - 1n;
export const GEARBOX_REPAY_ALL = (1n << 112n) - 1n;
export const GEARBOX_WITHDRAW_ALL = (1n << 112n) - 1n;
export const GEARBOX_ADD_COLLATERAL_PERMISSION = 1n << 0n;
export const GEARBOX_INCREASE_DEBT_PERMISSION = 1n << 1n;
export const GEARBOX_DECREASE_DEBT_PERMISSION = 1n << 2n;
export const GEARBOX_WITHDRAW_COLLATERAL_PERMISSION = 1n << 5n;
export const GEARBOX_UPDATE_QUOTA_PERMISSION = 1n << 6n;
export const TRANSFER_FROM = 0n;
export const SWEEP = 1n;
export const WRAP_NATIVE = 2n;
export const UNWRAP_WNATIVE = 3n;
export const PERMIT2_TRANSFER_FROM = 4n;
export const APPROVE = 5n;
export const WRAP = 6n;
export const SWEEP_NFT = 7n;
export const TOKEN_PERMIT = 0n;
export const AAVE_V3_CREDIT_PERMIT = 1n;
export const ALLOW_CREDIT_PERMIT = 2n;
export const AAVE_V4_BORROW_PERMIT = 3n;
export const AAVE_V4_WITHDRAW_PERMIT = 4n;
export const AAVE_V4_CONFIG_PERMIT = 5n;
export const AAVE_V4_PMS_BATCH_PERMIT = 6n;
export const UP_TO_AAVE_V3 = 1000n;
export const UP_TO_AAVE_V2 = 2000n;
export const UP_TO_COMPOUND_V3 = 3000n;
export const UP_TO_COMPOUND_V2 = 4000n;
export const UP_TO_MORPHO = 5000n;
export const UP_TO_SILO_V2 = 6000n;
export const UP_TO_AAVE_V4 = 7000n;
...
export const WITHDRAW = 3n;
export const DEPOSIT_LENDING_TOKEN = 4n;
export const WITHDRAW_LENDING_TOKEN = 5n;
export const SET_COLLATERAL = 6n;
export const LISTA_BROKER_BORROW = 7n;
export const LISTA_BROKER_REPAY = 8n;
export const FLUID_OPERATE = 10n;
...
export const UNI_V4_SYNC = 3n;
export const BAL_V3_TAKE = 4n;
export const BAL_V3_SETTLE = 5n;
export const EXT_CALL = 0x20n;
export const EXT_TRY_CALL = 0x21n;
export const EXT_CALL_WITH_REPLACE = 0x22n;
export const EXT_TRY_CALL_WITH_REPLACE = 0x23n;
export const LENDING = 0x30n;
export const TRANSFERS = 0x40n;
export const PERMIT = 0x50n;
export const FLASH_LOAN = 0x60n;
export const ERC4626 = 0x70n;
export const GEN_2025_SINGELTONS = 0x80n;
export const BRIDGING = 0x90n;
export const STARGATE_V2 = 0x00n;
export const ACROSS = 0x0an;
export const SQUID_ROUTER = 0x14n;
export const GASZIP = 0x1en;
export const MINT_BEHALF = 0n;
export const MINT = 1n;
export const MINT_ITOKEN = 2n;
export const REDEEM = 0n;
export const REDEEM_BEHALF = 1n;
export const REDEEM_ITOKEN = 2n;
...
export function encodeMidnightWithdrawCollateral(midnight, amount, args) {
    return encodePacked(["uint8", "uint8", "uint16", "address", "uint128", "uint16", "bytes"], [
        uint8(ComposerCommands.LENDING),
        uint8(LenderOps.WITHDRAW),
        MIDNIGHT_ID,
        midnight,
...
export function encodeMidnightWithdrawCollateralMax(midnight, id, args) {
    return encodePacked(["uint8", "uint8", "uint16", "address", "uint128", "bytes32", "uint16", "bytes"], [
        uint8(ComposerCommands.LENDING),
        uint8(LenderOps.WITHDRAW),
        MIDNIGHT_ID,
        midnight,
...
export function encodeMidnightRepayExactDebt(midnight, loanToken, id, args) {
    return encodePacked(["bytes", "uint8", "uint8", "uint16", "address", "address", "uint128", "bytes32", "uint16", "bytes"], [
        encodeApprove(loanToken, midnight),
        uint8(ComposerCommands.LENDING),
        uint8(LenderOps.REPAY),
        MIDNIGHT_ID,
...
export function encodeMidnightWithdraw(midnight, amount, args) {
    return encodePacked(["uint8", "uint8", "uint16", "address", "uint128", "uint16", "bytes"], [
        uint8(ComposerCommands.LENDING),
        uint8(LenderOps.WITHDRAW_LENDING_TOKEN),
        MIDNIGHT_ID,
...
export function encodeMidnightWithdrawMax(midnight, id, args) {
    return encodePacked(["uint8", "uint8", "uint16", "address", "uint128", "bytes32", "uint16", "bytes"], [
        uint8(ComposerCommands.LENDING),
        uint8(LenderOps.WITHDRAW_LENDING_TOKEN),
        MIDNIGHT_ID,
...
export function encodeListaBrokerRepay(loanToken, assets, native, broker, loanId, onBehalf) {
