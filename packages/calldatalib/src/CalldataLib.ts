...
export function encodeUniswapV4FlashLoan(
  ...
  let settle: Hex = encodeNextGenDexSettle(
    singleton,
    asset === zeroAddress ? amount : 0n,
  )
...
export function encodeFluidRepay(
  ...
  let debtAmount: bigint =
    amount === 0n || amount === FLUID_MAX_AMOUNT ? FLUID_ALL : -int128(amount)
  return encodeFluidT1Operate(
    zeroAddress,
    underlying,
    0n,
...
export function encodeFluidWithdraw(
  ...
  let colAmount: bigint =
    amount === FLUID_MAX_AMOUNT ? FLUID_ALL : -int128(amount)
  return encodeFluidT1Operate(
    underlying,
    zeroAddress,
    colAmount,
